...
key_mapper('n', 'g[', ':lua vim.lsp.diagnostic.goto_prev()<CR>')
key_mapper('n', 'g[', ':lua vim.lsp.diagnostic.goto_next()<CR>')
vim.api.nvim_command('autocmd CursorHold * lua vim.lsp.diagnostic.show_line_diagnostics()')
vim.api.nvim_command('autocmd InsertLeave,BufEnter,BufWinEnter,TabEnter,BufWritePost *.rs :lua require"lsp_extensions".inlay_hints{ prefix = " » ", highlight = "Comment"}')
